...
var RBY = {
    ...
    Articuno: {
        types: ['Ice', 'Flying'],
        bs: { hp: 95, at: 85, df: 100, sp: 85, sl: 125 },
        weightkg: 55.4
    },
    Beedrill: {
        types: ['Bug', 'Poison'],
    ...
    Chansey: {
        types: ['Normal'],
        bs: { hp: 250, at: 5, df: 15, sp: 45, sl: 105 },
        weightkg: 34.6
    },
    Charizard: {
        types: ['Fire', 'Flying'],
    ...
    Fearow: {
        types: ['Normal', 'Flying'],
        bs: { hp: 85, at: 120, df: 70, sp: 100, sl: 50 },
        weightkg: 38
    },
    ...
    Machamp: {
        types: ['Fighting'],
        bs: { hp: 100, at: 130, df: 85, sp: 55, sl: 65 },
        weightkg: 130
    },
    Machoke: {
        types: ['Fighting'],
    ...
    Magneton: {
        types: ['Electric'],
        bs: { hp: 65, at: 60, df: 100, sp: 70, sl: 120 },
        weightkg: 60
    },
    Mankey: {
        types: ['Fighting'],
    ...
    Pidgeot: {
        types: ['Normal', 'Flying'],
        bs: { hp: 83, at: 80, df: 75, sp: 100, sl: 70 },
        weightkg: 39.5
    },
    Pidgeotto: {
        types: ['Normal', 'Flying'],
    ...
    Poliwrath: {
        ...
        bs: { hp: 90, at: 90, df: 95, sp: 70, sl: 70 },
        weightkg: 54
    },
    Ponyta: {
        types: ['Fire'],
    ...
    Porygon: {
        types: ['Normal'],
        bs: { hp: 65, at: 60, df: 80, sp: 40, sl: 75 },
        weightkg: 36.5
    },
    Primeape: {
        types: ['Fighting'],
    ...
    Tangela: {
        types: ['Grass'],
        bs: { hp: 80, at: 80, df: 115, sp: 60, sl: 100 },
        weightkg: 35
    },
    Tauros: {
        types: ['Normal'],
    ...
    Zapdos: {
        ...
        bs: { hp: 95, at: 95, df: 90, sp: 105, sl: 125 },
        weightkg: 52.6
    },
    Zubat: {
        types: ['Poison', 'Flying'],
...
var GSC_PATCH = {
    ...
    Articuno: { bs: { sa: 110, sd: 125 }, gender: 'N' },
    ...
    Mewtwo: { bs: { sa: 160, sd: 90 }, gender: 'N' },
    ...
    Dunsparce: {
        types: ['Normal'],
        bs: { hp: 100, at: 70, df: 70, sa: 65, sd: 75, sp: 45 },
        weightkg: 14
    },
    Elekid: {
        types: ['Electric'],
    ...
    Magcargo: {
        types: ['Fire', 'Rock'],
        bs: { hp: 65, at: 50, df: 120, sa: 80, sd: 80, sp: 30 },
        weightkg: 55
    },
    Mantine: {
        types: ['Water', 'Flying'],
    ...
    Raikou: {
        types: ['Electric'],
        bs: { hp: 90, at: 95, df: 75, sa: 120, sd: 120, sp: 100 },
        weightkg: 178,
        gender: 'N'
    },
    Remoraid: {
...
var ADV_PATCH = {
    ...
    Cubone: { abilities: { 0: 'Lightning Rod' } },
    Dewgong: { abilities: { 0: 'Thick Fat' } },
    Diglett: { abilities: { 0: 'Arena Trap' } },
    Ditto: { abilities: { 0: 'Shadow Tag' } },
    Dodrio: { abilities: { 0: 'Early Bird' } },
    Doduo: { abilities: { 0: 'Early Bird' } },
    Dragonair: { abilities: { 0: 'Shed Skin' } },
    Dragonite: { abilities: { 0: 'Thick Fat' } },
    ...
    Golduck: { abilities: { 0: 'Cloud Nine' } },
    ...
    Kadabra: { abilities: { 0: 'Inner Focus' } },
    ...
    Lapras: { abilities: { 0: 'Shell Armor' } },
    ...
    Marowak: { abilities: { 0: 'Lightning Rod' } },
    ...
    Omastar: { abilities: { 0: 'Shell Armor' } },
    Onix: { abilities: { 0: 'Rock Head' } },
    Paras: { abilities: { 0: 'Poison Point' } },
    Parasect: { abilities: { 0: 'Poison Point' } },
    ...
    Squirtle: { abilities: { 0: 'Shell Armor' } },
    ...
    Vaporeon: { abilities: { 0: 'Swift Swim' } },
    ...
    Voltorb: { abilities: { 0: 'Static' } },
    Vulpix: { abilities: { 0: 'Pressure' } },
    Wartortle: { abilities: { 0: 'Shell Armor' } },
    ...
    Corsola: { abilities: { 0: 'Natural Cure' } },
    ...
    Houndour: { abilities: { 0: 'Own Tempo' } },
    ...
    Teddiursa: { abilities: { 0: 'Guts' } },
    Togepi: { abilities: { 0: 'Hustle' } },
    Togetic: { abilities: { 0: 'Serene Grace' } },
    Totodile: { abilities: { 0: 'Torrent' } },
    Typhlosion: { abilities: { 0: 'Flame Body' } },
    Tyranitar: { abilities: { 0: 'Intimidate' } },
